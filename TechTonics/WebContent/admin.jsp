...
<body>
	...
	<center>
        ...
        <h2>
        	<a href="new">Add New TechTalk</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="requested">Show Requested TechTalk</a>
        	&nbsp;&nbsp;&nbsp;
    ...
    <div align="center">
        <table border="1" cellpadding="5">
            <caption><h2>List of TeckTalk</h2></caption>
            <tr>
                <th>ID</th>
                <th>Title</th>
                <th>Description</th>
            ...
            <c:forEach var="techtalk" items="<%=TechTalkDAO.listAllTalks()%>">
                <tr>
                    ...
                    <td>
                    	...
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="delete?id=<c:out value='${techtalk.id}' />">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
